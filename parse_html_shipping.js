...
// Clean up some CSS classes textutil adds that we don't need
...
console.log('Successfully updated templates/page.shipping-and-delivery.json with full HTML content');
